    ...
    plants: [
      {
        ...
        name: 'Snake Plant',
        price: 24.99,
        image: 'https://images.unsplash.com/photo-1593482892290-f54927ae2b3b?auto=format&fit=crop&w=600&q=80'
      },
      {
        id: 2,
        name: 'Peace Lily',
      ...
      },
      {
        ...
        name: 'Spider Plant',
        price: 18.99,
        image: 'https://images.unsplash.com/photo-1620319040751-74b7f1f44d4d?auto=format&fit=crop&w=600&q=80'
      },
      {
        id: 4,
        name: 'Boston Fern',
  ...
  },
  {
    ...
    plants: [
      ...
      },
      {
        ...
        name: 'Pothos',
        price: 16.99,
        image: 'https://images.unsplash.com/photo-1614594895304-fe7116ac3b58?auto=format&fit=crop&w=600&q=80'
      },
      {
        id: 9,
        name: 'Aloe Vera',
        price: 14.99,
        image: 'https://images.unsplash.com/photo-1596547619652-9cf5d8f40c69?auto=format&fit=crop&w=600&q=80'
      },
      {
        id: 10,
        name: 'Jade Plant',
  ...
  },
  {
    ...
    plants: [
      ...
      },
      {
        ...
        price: 34.99,
        image: 'https://images.unsplash.com/photo-1614594879159-74d4bb18c30e?auto=format&fit=crop&w=600&q=80'
      },
      {
        id: 16,
        name: 'Bird of Paradise',
        price: 54.99,
        image: 'https://images.unsplash.com/photo-1597055181449-28c2e4e8e80f?auto=format&fit=crop&w=600&q=80'
      },
      {
        id: 17,
        name: 'String of Pearls',
        price: 21.99,
        image: 'https://images.unsplash.com/photo-1616500162516-4e097973f4f5?auto=format&fit=crop&w=600&q=80'
      },
      {
        id: 18,
        name: 'Anthurium',
...
function ProductList() {
  ...
  const handleAddToCart = (plant) => {
    ...
    setAddedToCart((previousButtons) => ({
      ...previousButtons,
      [plant.id]: true
    }));
  };
          ...
          <section className="plant-category" key={group.category}>
            ...
            <div className="plant-grid">
              {group.plants.map((plant) => {
                const inCart = addedToCart[plant.id] || isPlantInCart(plant.id);
